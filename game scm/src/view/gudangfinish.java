 ...
 * @author acer
 */
public class gudangfinish extends masterview {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(gudangfinish.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new gudangfinish().setVisible(true);
            }
        });
    }
